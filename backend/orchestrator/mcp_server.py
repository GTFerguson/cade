"""MCP server for CADE orchestrator — stdio transport.

Claude Code spawns this as an MCP server. It provides tools for
spawning agents and listing them. The spawn_agent tool blocks until
the agent's full lifecycle completes (user approval, execution,
report approval).
"""
